...
class Ad
{
    ...
    {
        // on boucle sur tous les commentaires de cette annonce
    ...
    {
        // ensemble des journées de toutes les réservations
        $notAvailableDays = [];

        foreach ($this->bookings as $booking) {
            // Calculer les jours qui se trouvent entre la date d'arrivée et de départ
            // $resultat = range(10, 20, 2);
            // $resultat = [10, 12, 14, 16, 18, 20]; éléments de 10 à 2O en comptant de 2 en 2 (step)
            $result = range(
